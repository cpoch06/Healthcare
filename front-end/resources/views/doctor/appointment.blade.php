        ...
        <div class="bg-white w-auto md:w-2/3 lg:w-1/2 xl:w-[700px] mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
            ...
            <table class="my-8 w-full text-sm">
                ...
                <tr>
                    ...
                    <td class="text-gray-900 py-2 px-6">{{ Carbon::parse($appointment->appointment_date)->format('Y-m-d') }}</td>
                </tr>
                <tr>
                    <th class="text-gray-700 text-left py-2">Time</th>
                    <td class="text-gray-900 py-2 px-6">{{ Carbon::parse($appointment->appointment_time)->format('H:i') }}</td>
                </tr>
                <tr>
                    <th class="text-gray-700 text-left py-2">Patient</th>
                    <td class="text-gray-900 py-2 px-6">{{ $appointment->patient_Lname }} {{ $appointment->patient_Fname }}</td>
                </tr>
                <tr>
            ...
            <div class="flex justify-center px-6">
                <button onclick="openModal()" class="items-center btn btn-outline btn-error mt-5 rounded-none w-48 hover:text-white">Cancel</button>
            </div>
        </div>
    </div>
</div>
