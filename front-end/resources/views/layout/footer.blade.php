<footer class="footer p-10 text-base-content mt-16 max-w-7xl mx-auto">
  <nav>
    <h6 class="footer-title">Services</h6> 
    <a href="/doctor" class="link link-hover">Primary Care</a>
    <a href="/doctor" class="link link-hover">Specialty Care</a>
    <a href="/doctor" class="link link-hover">Emergency Care</a>
    <a href="/doctor" class="link link-hover">Diagnostic Services</a>
  </nav> 
  <nav>
    <h6 class="footer-title">Company</h6> 
    <a href="/about" class="link link-hover">About us</a>
    <a href="/chatify" class="link link-hover">Contact</a>
    <a href="/review" class="link link-hover">Review</a>
...
<footer class="footer px-10 py-4 border-t text-base-content border-base-300 max-w-7xl mx-auto">
  <aside class="items-center grid-flow-col">
    ...
    <p>Paragon Healthcare Services <br>Providing reliable medical care since 1992</p>
  </aside> 
