...
<body>
    ...
    <header class="flex justify-center items-center h-fit" >
        <a href="/home"><img src="asset/logo.jpg" class="w-25 h-24" alt=""></a>
        <!-- For Front-End ONLY Prototype, Click img to go to the admin page,  -->
    </header>
    ...
    <div class="admin-login">
        ...
        <div class="flex flex-col bg-white items-center justify-center max-w-3xl mx-auto mt-16 min-h-fit px-4">
            ...
            <form action="#" method="" class="w-4/5 mx-auto">
                @csrf 
                <div class="flex flex-col mt-10">
                    <label for="email" class="items-start" >Email</label>
                    <input type="text" name="email" id="email" class="my-6 text-sm sm:text-base placeholder-gray-500 pl-6 pr-4 rounded-lg border border-main w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Enter your email" required> 
                </div>
                ...
                <div class="flex items-center mb-6 -mt-4">
                    <div class="flex ml-auto">
                        ...
                        <span class="inline-flex text-xs sm:text-sm text-main hover:text-blue-700">Remember me</spa>
                    </div>
                </div>
